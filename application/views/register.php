  ...
  <div class="col-xs-4">
    ...
    <form class="form-horizontal" action="/tmp/auth/register" method="post">
    <div class="control-group">
        <label class="control-label" for="inputCuname">고객사이름</label>
        <div class="controls">
          <input type="text" id="cuname" name="cuname" value="<?php echo set_value('cuname'); ?>" placeholder="고객사이름">
        </div>
      </div>
      <div class="control-group">
